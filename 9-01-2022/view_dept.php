...
{
echo "<table><tr><th>Dept ID</th><th>Name</th><th>Phone</th><th>Address</th><th>Operator</th><th>Update</th><th>Delete</th></tr>";
...
<td><button class="button1"><a href="update_dept.php?id=<?php echo $r['dept_id']; ?>">Edit</a></button></td>
