...
$sql="INSERT INTO tblcomplaints VALUES(NULL,'$Username','$category','$subject','$complaintDetails','$Place','$land_mark','$pin','$Phone',0,'$image',NULL)";
...
<form method="POST" action="reg_complaint_new.php" enctype="multipart/form-data">
<div class="container">
  <table  align ="center">
    <tr>
    <th colspan="2"><h1>Register Complaint</h1></th>
    </tr>
    <tr>
    <td id="a">Category</td>
